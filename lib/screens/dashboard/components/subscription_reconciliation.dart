...
class _SubscriptionTrackerPageState extends State<SubscriptionTrackerPage>
  ...
  Future<void> loadSubscriptions() async {
    ...
    try {
      // No orderBy — Firestore skips documents missing the field, causing records to disappear.
      // We sort in Dart instead (see filteredSubscriptions getter).
      ...
      _showErrorSnackBar('Failed to load subscriptions: $e');
    }
  }
  ...
  List<UserSubscription> get filteredSubscriptions {
    ...
    // Sort latest purchase date first; records with no date go to the bottom
    result.sort((a, b) {
      if (a.purchaseDateTime == null && b.purchaseDateTime == null) return 0;
      if (a.purchaseDateTime == null) return 1;
      if (b.purchaseDateTime == null) return -1;
      return b.purchaseDateTime!.compareTo(a.purchaseDateTime!);
    });
