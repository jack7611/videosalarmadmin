...
class _AdminChatWindowState extends State<AdminChatWindow> {
  ...
  Future<void> _sendMessage({String? text, String? imageUrl}) async {
    ...
    try {
      ...
      // Push notification is handled automatically by the Firebase Cloud Function
      // notifyUserOnAdminReply, which triggers on this message write and sends
      // only to the ticket owner's FCM tokens.
    } catch (e) {
      if (mounted) {
